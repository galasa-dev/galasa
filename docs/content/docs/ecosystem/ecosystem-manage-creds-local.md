...
4. Fill in the fields:
   ...
   - **Account Name**: Your actual username (e.g., `IBMUSER`)
   - **Password**: Your actual password or token
5. Click **Add**

#### Example

To create credentials for a system called `SIMBANK` with username `IBMUSER`:

- **Keychain Item Name**: `galasa.credentials.SIMBANK`
- **Account Name**: `IBMUSER`
- **Password**: `SYS1`
