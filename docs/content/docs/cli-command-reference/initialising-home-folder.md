...
| **cps.properties** | Stores configuration settings for your tests, such as endpoints, ports, and timeouts. These settings let you run the same test against different environments without changing your test code. Use the `@TestProperty` annotation in your tests to read values from this file. | 
