...
??? info "Key elements in Gradle files"
    ...
    plugins {
        id 'java'
        id 'maven-publish'
        id 'dev.galasa.tests' version '1.0.1'
    ...
    dependencies {
        implementation platform('dev.galasa:galasa-bom:1.0.1')
    ...
    plugins {
        id 'base'
        id 'maven-publish'
        id 'dev.galasa.obr' version '1.0.1'
        id 'dev.galasa.testcatalog' version '1.0.1'
    }
