...
public class TestGroupRuns {
    ...
    public void testCanCreateRunRasRecordOK() throws Exception {
        ...
        String restApiUrl = restApiBaseUrl + "/ras/runs/" + run.getRasRunId();
        assertThat(testStructure.getRestApiUrl()).isEqualTo(restApiUrl);
        
        String webuiUrl = webUIbaseUrl + "/test-runs/" + run.getRasRunId();
        assertThat(testStructure.getWebUiUrl()).isEqualTo(webuiUrl);
    }
