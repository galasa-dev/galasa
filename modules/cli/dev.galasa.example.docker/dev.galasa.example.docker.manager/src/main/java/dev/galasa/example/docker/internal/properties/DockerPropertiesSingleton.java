 ...
 * properties for the Docker Manager. All property classes should
...
public class DockerPropertiesSingleton {
     ...
     * @throws DockerManagerException if the CPS has not been initialized
     */
     ...
     * @throws DockerManagerException if the singleton has not been created
     */
