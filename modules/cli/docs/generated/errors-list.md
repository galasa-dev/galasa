...
- GAL1001E: Unsupported bootstrap URL {}. Acceptable values start with 'http' or 'https'. Use the --help flag for more information.
- GAL1002E: Bootstrap url does not end in '/bootstrap'. Bootstrap url is '{}'. Use the --help flag for more information.
...
- GAL1006E: The submit command does not support mixing of the test selection flags and a portfolio. Use the --help flag for more information.
- GAL1007E: Failed to create report yaml file {}. Reason is {}
- GAL1008E: Failed to check if group {} exists already. Reason is {}
- GAL1009E: The submit command requires either test selection flags (eg: --stream, --class, --bundle, --package, --tag, --regex, --test, --gherkin) or --portfolio flag to be specified. Use the --help flag for more information.
...
- GAL1031E: Invalid flags. --bundle, --package, --test, --tag, and --class flags can only be specified if --stream is provided. Use the --help flag for more information.
...
- GAL1037E: Invalid Java package name '{}' should not contain the '{}' character. Use the --help flag for more information.
- GAL1038E: Invalid Java package name '{}' should not start with the '{}' character. Use the --help flag for more information.
- GAL1039E: Invalid Java package name '{}' should not end with the '{}' character. Use the --help flag for more information.
- GAL1040E: Invalid Java package name. Package name should not be blank. Use the --help flag for more information.
...
- GAL1049E: Invalid value '{}' read from 'throttle' file '{}'. Reason is '{}'. Use the --help flag for more information.
...
- GAL1067E: Unsupported value '{}' for parameter --format. Supported values are: {}. Use the --help flag for more information.
...
- GAL1078E: Badly formed '--age' parameter value '{}' specified. Age of the test runs should be specified in the format '{FROM}{TIME-UNIT}:{TO}{TIME-UNIT}' or '{FROM}{TIME-UNIT}', where 'FROM' is a positive, non-zero integer, 'TO' is a non-negative integer, and 'TIME-UNIT' can be {}. 'FROM' must be greater than 'TO'. 'TO' defaults to 0 if not specified. Use the --help flag for more information.
- GAL1079E: The --age, --name, or --group parameter must be used to identify which test run(s) you want see. Use the --help flag for more information.
...
- GAL1088E: --active and --result must not be used at the same time, they are mutually exclusive. Use the --help flag for more information.
- GAL1089E: Need to use --maven and/or --gradle parameter Use the --help flag for more information.
- GAL1090E: Could not get username of current requestor. Reason is '{}'
- GAL1091E: '{}' is not a properly formed file URL Use the --help flag for more information.
...
- GAL1094E: User error: Cannot run test {} on a local JVM because no OBR information is available. Supply an OBR using the --obr parameter, or (if using a portfolio) ensure the portfolio contains an OBR for this test. Use the --help flag for more information.
- GAL1095E: namespace '{}' is invalid. Expected it to be in a format starting with letters, and ending in a number with no non-alphanumeric characters. Use the --help flag for more information.
- GAL1096E: Could not query namespace results. Reason: '{}'
- GAL1097E: Property --name cannot be set alongside --prefix, --suffix, or --infix. Use the --help flag for more information.
...
- GAL1101E: namespace '{}' is invalid. '--namespace' is a mandatory flag for this command. Use the --help flag for more information.
- GAL1102E: name '{}' is invalid. '--name' is a mandatory flag for this command. Use the --help flag for more information.
...
- GAL1193E: Invalid flag combination provided. --username cannot be provided with --base64-username, --password cannot be provided with --base64-password, and --token cannot be provided with --base64-token. Use the --help flag for more information.
