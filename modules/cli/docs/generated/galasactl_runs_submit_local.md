...
```
      ...
      --galasaVersion string   the version of galasa you want to use to run your tests. This should match the version of the galasa obr you built your test bundles against. (default "1.0.0")
  ...
  -h, --help                   Displays the options for the 'runs submit local' command.
      ...
      --offline                When set, the JVM will not contact any remote Maven repository during bundle resolution. Useful in restricted network environments. Cannot be used with --remoteMaven.
