...
```
      --base64-keystore-encoded string    a base64-encoded keystore (already base64-encoded) to set into a secret
      --base64-keystore-password string   a base64-encoded password for the keystore
  ...
  -h, --help                              Displays the options for the 'secrets set' command.
      --keystore-encoded string           a base64-encoded keystore to set into a secret
      --keystore-file string              the path to a keystore file (.p12 or .jks) to set into a secret
      --keystore-password string          the password for the keystore
