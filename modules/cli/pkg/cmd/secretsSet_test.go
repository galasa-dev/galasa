...
func TestSecretsSetNonEncodedUsernameFlagWithEncodedFlagProducesErrorMessage(t *testing.T) {
    ...
    checkOutput("", "Error: if any flags in the group [binary-file base64-binary-encoded username base64-username password base64-password token base64-token keystore-file base64-keystore-encoded] are set none of the others can be", factory, t)
}
...
func TestSecretsSetWithOnlyNameFlagProducesErrorMessage(t *testing.T) {
    ...
    checkOutput("", "Error: at least one of the flags in the group [username password token base64-username base64-password base64-token keystore-file base64-keystore-encoded keystore-type binary-file base64-binary-encoded description] is required", factory, t)
}
