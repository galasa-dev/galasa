...
var (
	...
	GALASA_ERROR_MISSING_KEYSTORE_PASSWORD           = NewMessageType(`GAL1292E: Invalid keystore password provided. When creating a keystore secret using --keystore-file or --base64-keystore-encoded, you must also provide --password or --base64-password. An empty string "" is valid and means no password.`+SEE_COMMAND_REFERENCE, 1292, STACK_TRACE_NOT_WANTED)
