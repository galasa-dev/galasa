...
var (
	...
	GALASA_ERROR_MISSING_KEYSTORE_PASSWORD           = NewMessageType("GAL1292E: Missing required keystore password. When creating a keystore secret using --keystore-file, --keystore-encoded, or --base64-keystore-encoded, you must also provide --keystore-password or --base64-keystore-password."+SEE_COMMAND_REFERENCE, 1292, STACK_TRACE_NOT_WANTED)
	GALASA_SET_SECRET_INVALID_KEYSTORE_FLAGS         = NewMessageType("GAL1293E: Invalid keystore flag combination provided. --keystore-file cannot be provided with --keystore-encoded or --base64-keystore-encoded, and --keystore-password cannot be provided with --base64-keystore-password."+SEE_COMMAND_REFERENCE, 1293, STACK_TRACE_NOT_WANTED)
